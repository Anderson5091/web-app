      ...
      <div className="flex-1 p-4 max-w-lg mx-auto w-full">
        ...
        <div className="bg-card rounded-xl p-4 border border-border space-y-2">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span className="text-text-primary font-medium">{withdrawal.amount} {CURRENCY_TOKEN}</span>
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-text-secondary">Fee</span>
            <span className="text-text-primary font-medium">{withdrawal.fee} {CURRENCY_TOKEN}</span>
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-text-secondary">Net Sent</span>
            <span className="text-danger font-bold">{withdrawal.netAmount} {CURRENCY_TOKEN}</span>
          </div>
          <div className="flex justify-between text-sm">
